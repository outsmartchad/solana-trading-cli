...
async function listenToWallets(address) {
  ...
  connection.onProgramAccountChange(
    ...
    async (data) => {
      ...
      if((changedMint in current_trader_wallet_state || current_trader_wallet_state[changedMint] > 0) && current_trader_wallet_state["SOL"] < previous_trader_wallet_state["SOL"]){
      ...
      let increasedToken = null, decreasedToken = null, increasedTokenPercentage = 0, decreasedTokenPercentage = 0;
