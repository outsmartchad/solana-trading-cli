...
import { TransactionMessage, Transaction, TransactionInstruction, VersionedTransaction, PublicKey} from "@solana/web3.js";
...
export async function swap(
  ...
  let amountIn:Decimal, inToken:PublicKey, outToken:PublicKey, tokenDecimal:number, quote:any;
  if(side === "buy"){
    ...
    const balance = await getSPLTokenBalance(connection, tokenMint, wallet.publicKey);
