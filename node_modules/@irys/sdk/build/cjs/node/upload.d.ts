...
export default class NodeUploader extends Uploader {
    ...
    walk(dir: string): AsyncGenerator<string, void, any>;
    /**
    ...
    }): Promise<((UploadResponse | UploadReceipt) & {
     ...
     * @returns A dataItem
     */
    protected processItem(item: string | Buffer | Readable | DataItem, opts?: CreateAndUploadOptions): Promise<any>;
    /**
