            ...
            switch (this.format) {
                case 1:
                    const tags = this.tags.reduce((accumulator, tag) => {
                        return ArweaveUtils.concatBuffers([accumulator, (0, utils_1.b64UrlToBuffer)(tag.name), (0, utils_1.b64UrlToBuffer)(tag.value)]);
                    }, new Uint8Array());
                ...
                case 2:
                    ...
                    const tagList = this.tags.map((tag) => [(0, utils_1.b64UrlToBuffer)(tag.name), (0, utils_1.b64UrlToBuffer)(tag.value)]);
