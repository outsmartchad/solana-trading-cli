...
exports.getStablePrice = exports.formatLayout = exports.getDxByDyBaseIn = exports.getDyByDxBaseIn = exports.ModelDataInfo = exports.DataElement = exports.ModelDataPubkey = void 0;
const web3_js_1 = require("@solana/web3.js");
const marshmallow_1 = require("../marshmallow");
exports.ModelDataPubkey = new web3_js_1.PublicKey('CDSr3ssLcRB6XYPJwAfFt18MZvEZp4LjHcvzBVZ45duo');
const ELEMENT_SIZE = 50000;
exports.DataElement = (0, marshmallow_1.struct)([(0, marshmallow_1.u64)('x'), (0, marshmallow_1.u64)('y'), (0, marshmallow_1.u64)('price')]);
exports.ModelDataInfo = (0, marshmallow_1.struct)([
    (0, marshmallow_1.u64)('accountType'),
    (0, marshmallow_1.u64)('status'),
    (0, marshmallow_1.u64)('multiplier'),
    (0, marshmallow_1.u64)('validDataCount'),
    (0, marshmallow_1.seq)(exports.DataElement, ELEMENT_SIZE, 'DataElement'),
]);
...
exports.getDyByDxBaseIn = getDyByDxBaseIn;
...
exports.getDxByDyBaseIn = getDxByDyBaseIn;
function formatLayout(buffer) {
    const layoutInfo = exports.ModelDataInfo.decode(buffer);
    return {
...
exports.getStablePrice = getStablePrice;
